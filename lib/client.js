window.__ModuleLoader__.load({
	...
	factory: (require) => {
			...
			return React.createElement("div", { className: "cdx-turn", onClick: go, role: "button", title: "打开审查视图" },
				...
				React.createElement("div", { className: "cdx-turn-main" },
					...
					React.createElement("div", { className: "cdx-turn-actions" },
						React.createElement(Tip, { text: "桌面组合未挂载撤回通道（Web 组合下可用）" },
							React.createElement("button", { type: "button", className: "cdx-turn-btn", disabled: true }, "撤销 ↺")),
						React.createElement("button", {
							type: "button",
		...
		function showTip(text, rect, below) {
			...
			setState({ tip: { text: text, top: below ? rect.bottom + 6 : rect.top - 6, left: rect.left + rect.width / 2, below: !!below } });
