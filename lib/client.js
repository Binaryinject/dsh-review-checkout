window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function detectTheme() {
			try {
				const v = getComputedStyle(document.body).getPropertyValue("--dsw-alias-surface-2") || "";
				const m = v.match(/\d+/g);
				if (m && m.length >= 3) {
		...
		function TurnReview({ matched, sessionId, turn: turnLoc, seq }) {
			...
			return React.createElement("div", { className: "cdx-turn", onClick: go, role: "button", title: "打开审查视图" },
				...
				React.createElement("div", { className: "cdx-turn-main" },
					...
					React.createElement("div", { className: "cdx-turn-body" },
						React.createElement("div", { className: "cdx-turn-title" }, "已编辑 " + title),
						React.createElement("div", { className: "cdx-turn-stats" },
							React.createElement("span", { className: "cdx-plus" }, "+" + local.added),
							React.createElement("span", { className: "cdx-minus" }, " −" + local.removed)),
				...
				local.files.length > 1 ? React.createElement("div", { className: "cdx-turn-files" },
					local.files.map((f) => React.createElement("div", { key: f.path, className: "cdx-turn-file" },
						...
						React.createElement("span", { className: "cdx-turn-file-stats" },
							React.createElement("span", { className: "cdx-plus" }, "+" + f.added),
							React.createElement("span", { className: "cdx-minus" }, " −" + f.removed))))) : null);
		}
		...
		function CodexLine({ h, lang }) {
			let sign = " ";
			let cls = "cdx-line";
			if (h.type === "add") { sign = "+"; cls += " cdx-add"; }
			else if (h.type === "del") { sign = "−"; cls += " cdx-del"; }
			const no = h.type === "add" ? h.b : h.a;
			const tokens = lang ? tokenizeLine(h.text || "", lang) : null;
			return React.createElement("div", { className: cls },
				React.createElement("span", { className: "cdx-gutter" }, no != null ? String(no) : ""),
				React.createElement("span", { className: "cdx-sign" }, sign),
				React.createElement("span", { className: "cdx-text" },
					tokens ? tokens.map((tk, i) => tk.t === "plain" ? tk.s : React.createElement("span", { key: i, className: "cdx-tok-" + tk.t }, tk.s))
						: (h.text === "" ? " " : h.text)));
		}
		...
		function CodexFileCard({ item, expanded, onToggle }) {
			...
			const head = React.createElement("button", { type: "button", className: "cdx-file-head", onClick: onToggle },
				...
				React.createElement("span", { className: "cdx-file-stats" },
					React.createElement("span", { className: "cdx-plus" }, "＋" + item.added),
					React.createElement("span", { className: "cdx-minus" }, "－" + item.removed)),
			...
			return React.createElement("div", { className: "cdx-file" }, head, body);
		}
		...
		function ChangePill() {
			...
			return React.createElement("div", {
				...
				React.createElement("span", { className: "cdx-plus" }, "+" + added),
				React.createElement("span", { className: "cdx-minus" }, " −" + removed));
		}
			...
			return React.createElement("div", { className: "drv-view" },
				...
				React.createElement("div", { className: "cdx-toolbar" },
					...
					React.createElement("span", { className: "cdx-stats" },
						React.createElement("span", { className: "cdx-plus" }, "＋" + total.added),
						React.createElement("span", { className: "cdx-minus" }, " －" + total.removed),
